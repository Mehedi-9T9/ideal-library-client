...
const About = () => {
    return (
        <div className='bg-[#FEF3F0] md:flex gap-x-10 container mx-auto my-10 p-20 rounded-xl'>
            <div className='md:w-[60%]'>
                <h2 className='text-4xl  text-[#B09CA9] font-platypi'>About Of Ideal Library</h2>
                <p className='text-balance text-[#B09CA9] font-poppins mt-7 w-[600px]'>An ideal library is more than just a repository of books; it's a dynamic hub of knowledge, creativity, and community engagement. Here's a description:
                    An ideal library is a welcoming space where the scent of aging </p>
                <p className='text-balance text-[#B09CA9] font-poppins mt-7 w-[600px]'>paper mixes with the soft hum of computers. Its shelves are lined with books of every genre and era, inviting exploration and discovery. Natural light pours in through large windows, illuminating cozy reading nooks and study corners. Comfortable seating arrangements cater to solitary readers seeking quiet introspection and lively discussion groups alike.</p>
            </div>
            <div className='md:w-[40%] grid grid-cols-2 gap-5'>
